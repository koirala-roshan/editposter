...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandtamil45');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandtamil45" className='firstdiv' style={{ width: '710px', height: '889px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandtamil45'>{Teachersname}</h5>
        <h5 id='linkanandtamil45'>{link}</h5>
        <h5 id='dateanandtamil45'>{date}</h5>
        <h5 id='timeanandtamil45'>{time}</h5>
        <h5 id='contactanandtamil45'>{contact}</h5>
        <h5 id='venueanandtamil45'>{venue}</h5>
...
export default Anandutsavtamil45;