...
const Followup2 = () => {
  ...
  const styles = {
    ...
    imagePreviewContainer: { width: '270px', height: '270px', borderRadius: '50%', overflow: 'hidden', marginTop: '480px', marginLeft:'37.1%', border: '2px solid white', position: 'relative'},
  ...
  return (
    ...
    <div className='container'>
      ...
      <div id="posterf2" className='firstdiv' style={{ width: '1080px', height: '1080px', border: '1px solid #000', padding: '20px' }}>
      
        <h5 id='teachersnamef2'>{Teachersname}<br/></h5>
