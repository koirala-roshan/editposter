...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandkannada45');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandkannada45" className='firstdiv' style={{ width: '710px', height: '889px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandkannada45'>{Teachersname}</h5>
        <h5 id='linkanandkannada45'>{link}</h5>
        <h5 id='dateanandkannada45'>{date}</h5>
        <h5 id='timeanandkannada45'>{time}</h5>
        <h5 id='contactanandkannada45'>{contact}</h5>
        <h5 id='venueanandkannada45'>{venue}</h5>
...
export default Anandutsavkannada45;