...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandbengoli');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandbengoli" className='firstdiv' style={{ width: '1080px', height: '1080px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandbengoli'>{Teachersname}</h5>
        <h5 id='linkanandbengoli'>{link}</h5>
        <h5 id='dateanandbengoli'>{date}</h5>
        <h5 id='timeanandbengoli'>{time}</h5>
        <h5 id='contactanandbengoli'>{contact}</h5>
        <h5 id='venueanandbengoli'>{venue}</h5>
...
export default Anandutsavbengoli;