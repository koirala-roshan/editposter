...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranand3');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranand3" className='firstdiv' style={{ width: '810px', height: '1440px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanand3'>{Teachersname}</h5>
        <h5 id='linkanand3'>{link}</h5>
        <h5 id='dateanand3'>{date}</h5>
        <h5 id='timeanand3'>{time}</h5>
        <h5 id='contactanand3'>{contact}</h5>
        <h5 id='venueanand3'>{venue}</h5>
