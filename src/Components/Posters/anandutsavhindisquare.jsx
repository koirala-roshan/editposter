...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandhindisquare');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandhindisquare" className='firstdiv' style={{ width: '1080px', height: '1080px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandhindisquare'>{Teachersname}</h5>
        <h5 id='linkanandhindisquare'>{link}</h5>
        <h5 id='dateanandhindisquare'>{date}</h5>
        <h5 id='timeanandhindisquare'>{time}</h5>
        <h5 id='contactanandhindisquare'>{contact}</h5>
        <h5 id='venueanandhindisquare'>{venue}</h5>
...
export default Anandutsavhindisquare;