...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandgujrati45');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandgujrati45" className='firstdiv' style={{ width: '710px', height: '889px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandgujrati45'>{Teachersname}</h5>
        <h5 id='linkanandgujrati45'>{link}</h5>
        <h5 id='dateanandgujrati45'>{date}</h5>
        <h5 id='timeanandgujrati45'>{time}</h5>
        <h5 id='contactanandgujrati45'>{contact}</h5>
        <h5 id='venueanandgujrati45'>{venue}</h5>
...
export default Anandutsavgujrati45;