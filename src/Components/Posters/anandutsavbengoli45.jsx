...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandbengoli45');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandbengoli45" className='firstdiv' style={{ width: '710px', height: '889px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandbengoli45'>{Teachersname}</h5>
        <h5 id='linkanandbengoli45'>{link}</h5>
        <h5 id='dateanandbengoli45'>{date}</h5>
        <h5 id='timeanandbengoli45'>{time}</h5>
        <h5 id='contactanandbengoli45'>{contact}</h5>
        <h5 id='venueanandbengoli45'>{venue}</h5>
...
export default Anandutsavbengoli45;