...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandkannada');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandkannada" className='firstdiv' style={{ width: '1080px', height: '1080px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandkannada'>{Teachersname}</h5>
        <h5 id='linkanandkannada'>{link}</h5>
        <h5 id='dateanandkannada'>{date}</h5>
        <h5 id='timeanandkannada'>{time}</h5>
        <h5 id='contactanandkannada'>{contact}</h5>
        <h5 id='venueanandkannada'>{venue}</h5>
...
export default Anandutsavkannada;