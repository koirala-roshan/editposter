...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandstory');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandstory" className='firstdiv' style={{ width: '810px', height: '1440px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandstory'>{Teachersname}</h5>
        <h5 id='linkanandstory'>{link}</h5>
        <h5 id='dateanandstory'>{date}</h5>
        <h5 id='timeanandstory'>{time}</h5>
        <h5 id='contactanandstory'>{contact}</h5>
        <h5 id='venueanandstory'>{venue}</h5>
...
export default Anandutsavhindistory;