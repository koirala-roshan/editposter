...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandmarathi');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandmarathi" className='firstdiv' style={{ width: '1080px', height: '1080px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandmarathi'>{Teachersname}</h5>
        <h5 id='linkanandmarathi'>{link}</h5>
        <h5 id='dateanandmarathi'>{date}</h5>
        <h5 id='timeanandmarathi'>{time}</h5>
        <h5 id='contactanandmarathi'>{contact}</h5>
        <h5 id='venueanandmarathi'>{venue}</h5>
...
export default Anandutsavmarathi;