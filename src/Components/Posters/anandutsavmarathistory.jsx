...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandmarathistory');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandmarathistory" className='firstdiv' style={{ width: '810px', height: '1440px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandmarathistory'>{Teachersname}</h5>
        <h5 id='linkanandmarathistory'>{link}</h5>
        <h5 id='dateanandmarathistory'>{date}</h5>
        <h5 id='timeanandmarathistory'>{time}</h5>
        <h5 id='contactanandmarathistory'>{contact}</h5>
        <h5 id='venueanandmarathistory'>{venue}</h5>
...
export default Anandutsavmarathistory;