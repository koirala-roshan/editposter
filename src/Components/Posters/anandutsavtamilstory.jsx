...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandtamilstory');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandtamilstory" className='firstdiv' style={{ width: '810px', height: '1440px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandtamilstory'>{Teachersname}</h5>
        <h5 id='linkanandtamilstory'>{link}</h5>
        <h5 id='dateanandtamilstory'>{date}</h5>
        <h5 id='timeanandtamilstory'>{time}</h5>
        <h5 id='contactanandtamilstory'>{contact}</h5>
        <h5 id='venueanandtamilstory'>{venue}</h5>
...
export default Anandutsavtamilstory;