...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandbengolistory');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandbengolistory" className='firstdiv' style={{ width: '810px', height: '1440px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandbengolistory'>{Teachersname}</h5>
        <h5 id='linkanandbengolistory'>{link}</h5>
        <h5 id='dateanandbengolistory'>{date}</h5>
        <h5 id='timeanandbengolistory'>{time}</h5>
        <h5 id='contactanandbengolistory'>{contact}</h5>
        <h5 id='venueanandbengolistory'>{venue}</h5>
...
export default Anandutsavbengolistory;