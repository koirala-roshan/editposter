...
//downloadpostercode
  ...
  const downloadPoster = async () => {
    ...
    const poster = document.getElementById('posteranandtelegu');
...
{/* <nav class="navbar fixedtop">
    ...
    <div className='container'>
      ...
      <div id="posteranandtelegu" className='firstdiv' style={{ width: '1080px', height: '1080px', border: '1px solid #000', padding: '20px' }}>

        <h5 id='teachersnameanandtelegu'>{Teachersname}</h5>
        <h5 id='linkanandtelegu'>{link}</h5>
        <h5 id='dateanandtelegu'>{date}</h5>
        <h5 id='timeanandtelegu'>{time}</h5>
        <h5 id='contactanandtelegu'>{contact}</h5>
        <h5 id='venueanandtelegu'>{venue}</h5>
...
export default Anandutsavtelegu;